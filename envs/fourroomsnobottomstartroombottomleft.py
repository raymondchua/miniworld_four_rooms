...
class FourRoomsNoBottomStartRoomBottomLeft(MiniWorldEnv):
    """
...
class FourRoomsNoBottomStartRoomBottomLeftActions(FourRoomsNoBottomStartRoomBottomLeft):
    """
...
class FourRoomsNoBottomStartRoomBottomLeftTwoTasks(
    FourRoomsNoBottomStartRoomBottomLeftActions
):
...
class FourRoomsNoBottomStartRoomBottomLeftTask1(
    FourRoomsNoBottomStartRoomBottomLeftTwoTasks
):
    def __init__(self):
        super().__init__(task_id=0)


class FourRoomsNoBottomStartRoomBottomLeftTask2(
    FourRoomsNoBottomStartRoomBottomLeftTwoTasks
):
    def __init__(self):
...
class FourRoomsNoBottomStartRoomBottomLeftSize2Task1(
    FourRoomsNoBottomStartRoomBottomLeftTwoTasks
):
    def __init__(self):
...
class FourRoomsNoBottomStartRoomBottomLeftSize2Task2(
    FourRoomsNoBottomStartRoomBottomLeftTwoTasks
):
    def __init__(self):
...
class FourRoomsNoBottomStartRoomBottomLeftSize3Task1(
    FourRoomsNoBottomStartRoomBottomLeftTwoTasks
):
    def __init__(self):
...
class FourRoomsNoBottomStartRoomBottomLeftSize3Task2(
    FourRoomsNoBottomStartRoomBottomLeftTwoTasks
):
    def __init__(self):
