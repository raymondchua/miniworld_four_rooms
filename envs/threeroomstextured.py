...
class ThreeRoomsTextured(MiniWorldEnv):
    """
    Three rooms environment with different textured walls for each different room.
...
class ThreeRoomsTexturedActions(ThreeRoomsTextured):
    """
...
class ThreeRoomsTexturedTwoTasks(ThreeRoomsTexturedActions):
...
class ThreeRoomsTexturedTask1(ThreeRoomsTexturedTwoTasks):
    def __init__(self):
        super().__init__(task_id=0)


class ThreeRoomsTexturedTask2(ThreeRoomsTexturedTwoTasks):
    def __init__(self):
