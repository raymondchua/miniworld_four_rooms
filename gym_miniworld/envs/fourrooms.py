...
class FourRoomsTwoTasks(FourRoomsActions):
...
class FourRoomsTask1(FourRoomsTwoTasks):
    def __init__(self):
        super().__init__(task_id=0)


class FourRoomsTask2(FourRoomsTwoTasks):
    def __init__(self):
        super().__init__(task_id=1)


class FourRoomsSize2Task1(FourRoomsTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.2)


class FourRoomsSize2Task2(FourRoomsTwoTasks):
    def __init__(self):
        super().__init__(task_id=1, scale=1.2)


class FourRoomsSize3Task1(FourRoomsTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.5)


class FourRoomsSize3Task2(FourRoomsTwoTasks):
    def __init__(self):
