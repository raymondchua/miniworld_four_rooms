...
class FourRoomsLeftStartRoomBottomLeft(MiniWorldEnv):
    """
...
class FourRoomsLeftStartRoomBottomLeftActions(FourRoomsLeftStartRoomBottomLeft):
    """
...
class FourRoomsLeftStartRoomBottomLeftTwoTasks(
    FourRoomsLeftStartRoomBottomLeftActions
):
...
class FourRoomsLeftStartRoomBottomLeftTask1(
    FourRoomsLeftStartRoomBottomLeftTwoTasks
):
    def __init__(self):
        super().__init__(task_id=0)


class FourRoomsLeftStartRoomBottomLeftTask2(
    FourRoomsLeftStartRoomBottomLeftTwoTasks
):
    def __init__(self):
...
class FourRoomsLeftStartRoomBottomLeftSize2Task1(
    FourRoomsLeftStartRoomBottomLeftTwoTasks
):
    def __init__(self):
...
class FourRoomsLeftStartRoomBottomLeftSize2Task2(
    FourRoomsLeftStartRoomBottomLeftTwoTasks
):
    def __init__(self):
...
class FourRoomsLeftStartRoomBottomLeftSize3Task1(
    FourRoomsLeftStartRoomBottomLeftTwoTasks
):
    def __init__(self):
...
class FourRoomsLeftStartRoomBottomLeftSize3Task2(
    FourRoomsLeftStartRoomBottomLeftTwoTasks
):
    def __init__(self):
