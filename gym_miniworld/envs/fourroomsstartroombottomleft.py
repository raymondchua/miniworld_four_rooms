...
class FourRoomsStartRoomBottomLeft(MiniWorldEnv):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        agent_x = np.random.uniform(-6, -1.6)
        agent_z = np.random.uniform(1.4, 6.5)
        self.agent_pos = [agent_x, 0.0, agent_z]
        self._scale = scale  # scale the size of the rooms
    ...
    def _gen_world(self):
        ...
        self.connect_rooms(
            room2, room3, min_z=-5 * self._scale, max_z=-3 * self._scale, max_y=2.2
        )
        self.connect_rooms(
...
class FourRoomsStartRoomBottomLeftActions(FourRoomsStartRoomBottomLeft):
    """
    Classic four rooms environment.
    The agent must reach the red box to get a reward.
    """
...
class FourRoomsStartRoomBottomLeftTwoTasks(FourRoomsStartRoomBottomLeftActions):
...
class FourRoomsStartRoomBottomLeftTask1(FourRoomsStartRoomBottomLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0)


class FourRoomsStartRoomBottomLeftTask2(FourRoomsStartRoomBottomLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=1)


class FourRoomsStartRoomBottomLeftSize2Task1(FourRoomsStartRoomBottomLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.2)


class FourRoomsStartRoomBottomLeftSize2Task2(FourRoomsStartRoomBottomLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=1, scale=1.2)


class FourRoomsStartRoomBottomLeftSize3Task1(FourRoomsStartRoomBottomLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.5)


class FourRoomsStartRoomBottomLeftSize3Task2(FourRoomsStartRoomBottomLeftTwoTasks):
    def __init__(self):
