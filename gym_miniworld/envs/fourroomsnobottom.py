...
class FourRoomsNoBottom(MiniWorldEnv):
    """
...
class FourRoomsNoBottomTask1(FourRoomsNoBottomTwoTasks):
    def __init__(self):
        super().__init__(task_id=0)


class FourRoomsNoBottomTask2(FourRoomsNoBottomTwoTasks):
    def __init__(self):
        super().__init__(task_id=1)


class FourRoomsNoBottomSize2Task1(FourRoomsNoBottomTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.2)


class FourRoomsNoBottomSize2Task2(FourRoomsNoBottomTwoTasks):
    def __init__(self):
        super().__init__(task_id=1, scale=1.2)


class FourRoomsNoBottomSize3Task1(FourRoomsNoBottomTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.5)


class FourRoomsNoBottomSize3Task2(FourRoomsNoBottomTwoTasks):
    def __init__(self):
