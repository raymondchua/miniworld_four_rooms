...
class FourRoomsNoBottomTextureChanged(MiniWorldEnv):
    """
    Modification of the classic four rooms without connecting room in the bottom environment and different textures.
