...
class FourRoomsNoTopStartRoomTopLeft(MiniWorldEnv):
    """
...
class FourRoomsNoTopStartRoomTopLeftActions(FourRoomsNoTopStartRoomTopLeft):
    """
...
class FourRoomsNoTopStartRoomTopLeftTwoTasks(FourRoomsNoTopStartRoomTopLeftActions):
...
class FourRoomsNoTopStartRoomTopLeftTask1(FourRoomsNoTopStartRoomTopLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0)


class FourRoomsNoTopStartRoomTopLeftTask2(FourRoomsNoTopStartRoomTopLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=1)


class FourRoomsNoTopStartRoomTopLeftSize2Task1(FourRoomsNoTopStartRoomTopLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.2)


class FourRoomsNoTopStartRoomTopLeftSize2Task2(FourRoomsNoTopStartRoomTopLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=1, scale=1.2)


class FourRoomsNoTopStartRoomTopLeftSize3Task1(FourRoomsNoTopStartRoomTopLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.5)


class FourRoomsNoTopStartRoomTopLeftSize3Task2(FourRoomsNoTopStartRoomTopLeftTwoTasks):
    def __init__(self):
