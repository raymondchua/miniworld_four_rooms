...
class FourRoomsNoLeft(MiniWorldEnv):
    """
...
class FourRoomsNoLeftActions(FourRoomsNoLeft):
    """
...
class FourRoomsNoLeftTwoTasks(FourRoomsNoLeftActions):
...
class FourRoomsNoLeftTask1(FourRoomsNoLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0)


class FourRoomsNoLeftTask2(FourRoomsNoLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=1)


class FourRoomsNoLeftSize2Task1(FourRoomsNoLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.2)


class FourRoomsNoLeftSize2Task2(FourRoomsNoLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=1, scale=1.2)


class FourRoomsNoLeftSize3Task1(FourRoomsNoLeftTwoTasks):
    def __init__(self):
        super().__init__(task_id=0, scale=1.5)


class FourRoomsNoLeftSize3Task2(FourRoomsNoLeftTwoTasks):
    def __init__(self):
